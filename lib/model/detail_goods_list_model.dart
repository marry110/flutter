class DeailModel {
  String code;
  String message;
  DeailsGoodsData data;

  DeailModel({this.code, this.message, this.data});

  DeailModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null
        ? new DeailsGoodsData.fromJson(json['data'])
        : null;
  }
...
class DeailsGoodsData {
  GoodInfo goodInfo;
  List<GoodComments> goodComments;
  AdvertesPicture advertesPicture;

  DeailsGoodsData({this.goodInfo, this.goodComments, this.advertesPicture});

  DeailsGoodsData.fromJson(Map<String, dynamic> json) {
